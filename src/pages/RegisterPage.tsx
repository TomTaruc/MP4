      ...
      <div className="w-full max-w-lg">
        ...
        <div className="rounded-2xl p-8" style={{
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" value={fullName} onChange={e => setFullName(e.target.value)} required
                  placeholder="Your full name" className={`${inputClass} pl-10`} style={inputStyle} />
              </div>
            </div>
          ...
          <p className="text-center text-purple-400 text-sm mt-6">
            ...
            <button onClick={() => onNavigate('login')} className="text-cyan-400 hover:text-cyan-300 font-medium">
              Sign in
            </button>
          </p>
        </div>
