    ...
    <div className="min-h-screen flex items-center justify-center px-4 relative z-10">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-1" style={{ fontFamily: 'Cinzel, serif' }}>Welcome Back</h1>
        ...
        <div className="rounded-2xl p-8" style={{
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {error && (
              <div className="p-3 rounded-lg text-red-300 text-sm"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  style={{ background: 'rgba(26,5,51,0.6)', border: '1px solid rgba(123,97,255,0.3)' }}
                />
          ...
          <p className="text-center text-purple-400 text-sm mt-6">
            ...
            <button onClick={() => onNavigate('register')} className="text-cyan-400 hover:text-cyan-300 font-medium transition-colors">
              Create one
            </button>
          </p>
        </div>

        <button onClick={() => onNavigate('landing')} className="block text-center text-purple-500 hover:text-purple-300 text-sm mt-4 mx-auto transition-colors">
          Back to home
        </button>
      </div>
    </div>
